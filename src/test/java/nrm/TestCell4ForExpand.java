...
public class TestCell4ForExpand extends TestCase{
	
	@Test
	public void testRule() {
		NrmRule nrmRule = NrmUtil.getNrmRule("Cell4");
		...
		assertEquals("me=1001,enb=1,cell=100,cell100,1100,me=1001,enb=1,300,1100;1101," +
						"me=1001,enb=1,cell=101,cell101,1101,me=1001,enb=1,300,1100;1101," +
						"me=1001,enb=2,cell=102,cell102,1102,me=1001,enb=2,301,1102;1103," +
						"me=1001,enb=3,cell=103,cell103,1103,me=1001,enb=2,301,1102;1103," +
						"me=1001,enb=3,cell=104,cell104,1104,me=1001,enb=3,303,1104;1105," +
						"me=1001,enb=3,cell=105,cell105,1105,me=1001,enb=3,303,1104;1105,"
