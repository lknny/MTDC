...
public class TestCell3ForMk extends TestCase{
	
	@Test
	public void testRule() {
		NrmRule nrmRule = NrmUtil.getNrmRule("Cell3");
		...
		assertEquals("[me=1001,enb=1,cell=100, me=1001,enb=1,cell=101],[cell100, cell101],[1100, 1101],me=1001,enb=1,300,1100;1101," +
						"[me=1001,enb=2,cell=102, me=1001,enb=3,cell=103, me=1001,enb=3,cell=104],[cell102, cell103, cell104],[1102, 1103, 1104],me=1001,enb=2,301,1102;1103;1104," +
						"[me=1001,enb=3,cell=105],[cell105],[1105],me=1001,enb=3,303,1105,"
